...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~516c4e383e3a84488f9bea762d6c110f:652b304349744162354a593d',
    ...
    SUDO: process.env.SUDO || "2347066506899",
